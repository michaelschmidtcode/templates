...
<main class="container">
  <div id="blockNew">
    <form id="editMovieForm">
        ...
        <br><button type="button" onclick="insertMovie();" class="btn btn-dark">Änderung speichern</button>
    </form>
    ...
    <br><button type="button" onclick="backToCreate();" class="btn btn-dark">zurück zur Erfassung</button>
    </div>
