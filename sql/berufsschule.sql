...
-- 5
select f.frage as "Frage", a.Antwort as "Antwort", fg.fachgebiet as "Fachgebiet", t.themengebiet as "Themengebiet" from frageboegen fb
...
join fragen on fragen.id = ahf.frageboegen_id
join themengebiete t on fht.themengebiete_Id join fachgebiete fg on fg.id = t.fachgebiete_id order by fg.fachgebiet, t.themengebiet;
-- 6
